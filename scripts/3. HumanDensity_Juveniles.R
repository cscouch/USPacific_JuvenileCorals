...
#Read in site-level juvenile data
...
#Several of the islands do actually have year-round field staff, or the values in the NASA data are not accurate. Correct this using the following code
df<-df %>%
